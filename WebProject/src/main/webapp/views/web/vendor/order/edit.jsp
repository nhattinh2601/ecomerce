            ...
            <div id="editEmployeeModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="${pageContext.request.contextPath}/store-order/update" method="post">
                            <div class="modal-header">						
                                <h4 class="modal-title">Edit Order Status</h4>
                            </div>
                            <div class="form-group">
                                    <input value="${cart.cartId}" name="cartId" type="text" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
