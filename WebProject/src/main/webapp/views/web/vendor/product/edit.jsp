            ...
            <div id="editEmployeeModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="${pageContext.request.contextPath}/store-product/update" method="post">
                            ...
                            <div class="modal-body">					
                               ...
                               <label>Category</label>
                                <select onchange="myFunction()" name="categoryId" id="categoryganvao" class="form-select" aria-label="Default select example" >
                                    <c:forEach items="${categorys}" var="o" varStatus="loop">
                                        <option name="categoryId"  value="${o.categoryId}">${o.categoryName}</option>
                                    </c:forEach>
                                </select>
                                <div hidden class="form-group">
                                    <label>Category Id</label>
                                    <input id="ganvao" value="${product.category.categoryId}" name="categoryId" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${product.store.storeId}" name="storeId" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
