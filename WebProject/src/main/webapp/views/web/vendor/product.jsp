...
<body>
	...
	<section class="jumbotron text-center" style="background: white;">
		<div class="container"
			style="heigth: 100px; width: 300px; border: 1px solid #eeeeee; border-radius: 10px; padding: 20px 50px; margin-left: -10px">
			<img src="${detailStore.images}" alt="Shop Image" width="60px"
				height="60px">
			<h4 style="margin-top: 10px">${detailStore.storeName}</h4>
		</div>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="card  ">
						...
						<form action="${pageContext.request.contextPath}/vendor/search"
								method="post"> 
							<div class="input-group input-group-sm">
								<input  value="${txtS}" name="txt"
						...
						<ul class="list-group ">
							<c:forEach items="${listCC}" var="o">
								<li><a
									class="list-group-item text-back ${tagCate == o.categoryId ? "
									active":""}"
								href="${pageContext.request.contextPath}/vendor/category?categoryId=${o.categoryId}">${o.categoryName}</a></li>
							</c:forEach>
										...
										<div class="product__item">
											...
											<div class="product__item__pic set-bg"
												...
												<a
													...
													class="card-img-top" src="${o.images }" width="600"
													height="280" alt="Card image cap"></a> <span
													class="label">Real</span>
											...
											<div class="product__item__text">
												<h6
													href="${pageContext.request.contextPath}/product/detail?pid=${o.productId}">${o.productName}</h6>
